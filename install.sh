#!/usr/bin/env sh
# Universal installer for agentpassport. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/agentpassport.git"
echo "Installing agentpassport ..."
...
echo "Done. Run: agentpassport --help"
